...
@Component({
  selector: 'app-inpatient-status-type-create',
  templateUrl: './inpatient-status-type-create.component.html',
  styleUrls: ['./inpatient-status-type-create.component.css']
})
export class InpatientStatusTypeCreateComponent implements OnInit {
