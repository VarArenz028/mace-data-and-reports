...
@Component({
  selector: 'app-procedure-approval-type',
  templateUrl: './procedure-approval-type.component.html',
  styleUrls: ['./procedure-approval-type.component.css'],
  animations: [routerTransition()]
})
export class ProcedureApprovalTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Procedure Approval Type';
