...
@Component({
  selector: 'app-disposition-type',
  templateUrl: './disposition-type.component.html',
  styleUrls: ['./disposition-type.component.css'],
  animations: [routerTransition()]
})
export class DispositionTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Disposition Type';
