...
@Component({
  selector: 'app-procedure-group-type',
  templateUrl: './procedure-group-type.component.html',
  styleUrls: ['./procedure-group-type.component.css'],
  animations: [routerTransition()]
})
export class ProcedureGroupTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Procedure Group Type';
