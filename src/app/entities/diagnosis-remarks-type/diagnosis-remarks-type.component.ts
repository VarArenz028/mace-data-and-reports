...
@Component({
  selector: 'app-diagnosis-remarks-type',
  templateUrl: './diagnosis-remarks-type.component.html',
  styleUrls: ['./diagnosis-remarks-type.component.css'],
  animations: [routerTransition()]
})
export class DiagnosisRemarksTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Diagnosis Remarks Type';
