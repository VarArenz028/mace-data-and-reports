...
@Component({
  ...
  templateUrl: './doctor-type.component.html',
  styleUrls: ['./doctor-type.component.css'],
  animations: [routerTransition()]
})
export class DoctorTypeComponent implements OnInit {
