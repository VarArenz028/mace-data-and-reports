...
@Component({
  selector: 'app-procedure-remarks-type-create',
  templateUrl: './procedure-remarks-type-create.component.html',
  styleUrls: ['./procedure-remarks-type-create.component.css']
})
export class ProcedureRemarksTypeCreateComponent implements OnInit {
