...
@Component({
  selector: 'app-temporary-procedure-create',
  templateUrl: './temporary-procedure-create.component.html',
  styleUrls: ['./temporary-procedure-create.component.css']
})
export class TemporaryProcedureCreateComponent implements OnInit {
