...
@Component({
  selector: 'app-temporary-procedure',
  templateUrl: './temporary-procedure.component.html',
  styleUrls: ['./temporary-procedure.component.css'],
  animations: [routerTransition()]
})
export class TemporaryProcedureComponent implements OnInit {

  entityName: string = "Temporary Procedure";
