...
@Component({
    selector: 'app-diagnosis-case-type',
    templateUrl: './diagnosis-case-type.component.html',
    styleUrls: ['./diagnosis-case-type.component.css'],
    animations: [routerTransition()]
})
export class DiagnosisCaseTypeComponent implements OnInit {
    ...
    updateDataId: number;
    entityName: string = 'Diagnosis Case Type';
