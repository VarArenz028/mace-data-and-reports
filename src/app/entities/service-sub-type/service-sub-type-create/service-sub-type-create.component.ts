...
@Component({
  selector: 'app-service-sub-type-create',
  templateUrl: './service-sub-type-create.component.html',
  styleUrls: ['./service-sub-type-create.component.css']
})
export class ServiceSubTypeCreateComponent implements OnInit {
