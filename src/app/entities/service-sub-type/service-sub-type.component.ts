...
@Component({
  selector: 'app-service-sub-type',
  templateUrl: './service-sub-type.component.html',
  styleUrls: ['./service-sub-type.component.css'],
  animations: [routerTransition()]
})
export class ServiceSubTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = "Service Sub Type";
