...
@Component({
  selector: 'app-loa-checklist-type',
  templateUrl: './loa-checklist-type.component.html',
  styleUrls: ['./loa-checklist-type.component.css'],
  animations: [routerTransition()]
})
export class LoaChecklistTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Inquiry Type';
