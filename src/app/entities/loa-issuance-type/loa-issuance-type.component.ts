...
@Component({
  selector: 'app-loa-issuance-type',
  templateUrl: './loa-issuance-type.component.html',
  styleUrls: ['./loa-issuance-type.component.css'],
  animations: [routerTransition()]
})
export class LoaIssuanceTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'LOA Issuance Type';
