...
@Component({
  selector: 'app-loa-issuance-type-create',
  templateUrl: './loa-issuance-type-create.component.html',
  styleUrls: ['./loa-issuance-type-create.component.css']
})
export class LoaIssuanceTypeCreateComponent implements OnInit {
