...
@Component({
  selector: 'app-request-channel-type',
  templateUrl: './request-channel-type.component.html',
  styleUrls: ['./request-channel-type.component.css'],
  animations: [routerTransition()]
})
export class RequestChannelTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = "Request Channel Type";
