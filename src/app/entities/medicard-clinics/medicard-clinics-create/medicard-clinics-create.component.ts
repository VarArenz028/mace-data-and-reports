...
@Component({
  selector: 'app-medicard-clinics-create',
  templateUrl: './medicard-clinics-create.component.html',
  styleUrls: ['./medicard-clinics-create.component.css']
})
export class MedicardClinicsCreateComponent implements OnInit {
