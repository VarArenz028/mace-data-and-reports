...
@Component({
  selector: 'app-medicard-clinics',
  templateUrl: './medicard-clinics.component.html',
  styleUrls: ['./medicard-clinics.component.css'],
  animations: [routerTransition()]
})
export class MedicardClinicsComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Medicard Clinics';
