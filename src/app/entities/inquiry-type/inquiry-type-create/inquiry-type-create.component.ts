...
@Component({
  selector: 'app-inquiry-type-create',
  templateUrl: './inquiry-type-create.component.html',
  styleUrls: ['./inquiry-type-create.component.css']
})
export class InquiryTypeCreateComponent implements OnInit {
