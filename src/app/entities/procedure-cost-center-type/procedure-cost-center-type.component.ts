...
@Component({
  selector: 'app-procedure-cost-center-type',
  templateUrl: './procedure-cost-center-type.component.html',
  styleUrls: ['./procedure-cost-center-type.component.css'],
  animations: [routerTransition()]
})
export class ProcedureCostCenterTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Procedure Cost Center Type';
