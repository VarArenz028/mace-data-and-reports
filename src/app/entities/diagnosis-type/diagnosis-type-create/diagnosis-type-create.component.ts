...
@Component({
  selector: 'app-diagnosis-type-create',
  templateUrl: './diagnosis-type-create.component.html',
  styleUrls: ['./diagnosis-type-create.component.css']
})
export class DiagnosisTypeCreateComponent implements OnInit {
