...
@Component({
  selector: 'app-hospital-procedure-create',
  templateUrl: './hospital-procedure-create.component.html',
  styleUrls: ['./hospital-procedure-create.component.css']
})
export class HospitalProcedureCreateComponent implements OnInit {
