...
@Component({
  selector: 'app-hospital-procedure',
  templateUrl: './hospital-procedure.component.html',
  styleUrls: ['./hospital-procedure.component.css'],
  animations: [routerTransition()]
})
export class HospitalProcedureComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = "Hospital Procedures";
