...
@Component({
  selector: 'app-other-information-type',
  templateUrl: './other-information-type.component.html',
  styleUrls: ['./other-information-type.component.css'],
  animations: [routerTransition()]
})
export class OtherInformationTypeComponent implements OnInit {
  ...
  updateDataId: number;
  entityName: string = 'Other Information Type';
