...
@Component({
  ...
  templateUrl: './admission-type-create.component.html',
  styleUrls: ['./admission-type-create.component.css']
})
export class AdmissionTypeCreateComponent implements OnInit {
